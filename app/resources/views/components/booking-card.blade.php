...
<div {{$attributes->merge(['class' => $defaultClasses])}}>
  ...
  <div class="p-6">
    <div class="mb-3 flex items-center justify-between">
      <h5 class="block font-sans font-medium leading-snug tracking-normal text-white antialiased text-sm">
        {{Str::limit($title, 29)}}
      </h5>
    ...
    <p class="block font-sans text-xs font-light leading-relaxed text-white antialiased max-h-5">
      {{$description}}
    </p>
