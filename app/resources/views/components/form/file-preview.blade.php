@props(['label' => ''])
<span {{$attributes->merge(['class' => 'z-[1] relative text-white font-bold bg-slate-500 rounded-md py-5 mb-2 text-center justify-center align-middle'])}} title="{{$filename}}">
