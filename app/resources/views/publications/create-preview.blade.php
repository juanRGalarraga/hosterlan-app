...
<div id="preview"  class="flex flex-row border-solid border-2 p-3 bg-gray-900 rounded-lg text-white w-4/5 mx-8 my-6">
    <section class="flex flex-row w-full pt-6">
        <div id="preview-carousel" class="border-solid border-2 w-3/5 relative" data-carousel="slide">

            <div class="bg-slate-500 flex justify-center py-auto items-center w-full h-full -z-10">
        ...
        <div class="flex flex-col w-2/5">
            <section class="border-solid border-2 w-full overflow-y-auto show-scroll fixed-filters-zone my-h-screen my-max-h-screen">
                <!-- <section class="text-2xl">Titulo</section>
                <section class="text-2xl">Titulo</section>
                <section class="text-2xl">Titulo</section>
                <section class="text-2xl">Titulo</section>
                <section class="text-2xl">Titulo</section>
            ...
            <div class="bottom-0 relative">
                <button class="w-full border-solid border-2">Enviar Mensaje</button>
            </div>
        </div>
    </section>
</div>