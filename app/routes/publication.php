...
Route::any('publications/create/1', [PublicationController::class, 'createStep1'])->name('publications.create1');
Route::any('publications/create/2', [PublicationController::class, 'createStep2'])->name('publications.create2');
